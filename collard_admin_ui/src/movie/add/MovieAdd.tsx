...
const MovieAdd = () => {
  ...
  const ctaItems = <Button data-automation-id={"save-button"} disabled={!movieContext.state.isValid}> Save </Button>;
  ...
  return (
    <Stack className={'MovieMainSection'}>
      ...
      <TabPanel value={currentTab} items={MovieAddTabs} onChange={(e,v) => setCurrentTab(v)}/>
